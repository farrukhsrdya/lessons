...
class Register(View):
    ...
    def post(self, request):
        ...
        context = {'form': RegForm, 'message': 'Пароль или почта неверены!'}
        return render(request, self.template_name, context)
...
def search(request):
    if request.method == 'POST':
        ...
        if News.objects.get(news_name__iregex=get_news):
            searched_news = News.ojects.get(news_name__iregex=get_news)
